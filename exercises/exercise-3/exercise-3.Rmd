...
Here we see there is a `r round(mean(year.samples < 0), 2)` probability of a decline in occupancy probability, indicating fairly substantial support for a decline.

## Model 2: Random year effect and random BCR effect
